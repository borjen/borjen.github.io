    ...
    <div class="timeline">
      <div class="timeline-item">
        ...
        <ul>
          ...
          <li>ESG 永續承諾驗證競賽與標註資料蒐集計畫 (AI Cup 2026 <a href="https://veripromiseesg.github.io/" target="_blank" style="color: inherit; text-decoration: underline;">VeriPromiseESG</a>)</li>
          <li>前瞻AI技術人才培育-智慧代理與實體AI課程推動計畫 (<a href="https://napaincu.github.io/" target="_blank" style="color: inherit; text-decoration: underline;">NAPAI</a>)</li>
...
`,
  ...
  award: `
   <ul class="activity-list">
      <li>2026 北聯大人工智慧代理創新創業跨域競賽 — <b>第一名</b></li>
      <li>2026 臺北大學AI智慧跨域整合創作競賽 AI與永續數位應用組 — 佳作</li>
      <li>2025 NTPU USR × REsolution再想解⽅永續科技提案競賽 — <b>第⼀名</b></li>
    ...
    <div class="timeline">
      <div class="timeline-item">
        ...
        <ul>
          ...
          <li>ESG Sustainability Commitment Verification Competition and Annotation Data Collection Project (AI Cup 2026 <a href="https://veripromiseesg.github.io/" target="_blank" style="color: inherit; text-decoration: underline;">VeriPromiseESG</a>)</li>
          <li>Agentic AI and Physical AI Curriculum Development Project, Advanced AI Talent Cultivation Program (<a href="https://napaincu.github.io/" target="_blank" style="color: inherit; text-decoration: underline;">NAPAI</a>)</li>
...
`,
  ...
  award: `
    <div class="activity-list">
      <li>2026 USTP AI Agent Innovation and Entrepreneurship Interdisciplinary Competition — <b>First Place</b></li>
      <li>2026 AI Smart Interdisciplinary Integration Creative Competition, AI and Sustainable Digital Applications Category — Honorable Mention</li>
      <li>2025 NTPU USR x REsolution Sustainability Tech Proposal Competition — <b>First Place</b></li>
      <li><b>Best Paper Award</b>, Bor-Jen Chen and Min-Yuh Day (2025), AI-Assisted ESG Reporting: A RAG-Based Framework for Accurate and Stylistically Appropriate Text Generation", The 31st International Conference on IT Applications and Management (ITAM), Jinju, Korea, October 26-30, 2025.</li>
